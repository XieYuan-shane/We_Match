<template>
  ...
  <van-tabbar v-model="active" v-if="!NOT_SHOW_NAVBAR_AND_TABBAR.includes(route.path)" @change="onChange" route>
    <van-tabbar-item icon="search" name="index" replace to="/">队伍</van-tabbar-item>
    <van-tabbar-item icon="forum-o" name="forum" replace to="/">论坛</van-tabbar-item>
    <van-tabbar-item icon="information-o" name="information" replace to="/">消息</van-tabbar-item>
